...
const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      <button className="mt-10 px-40 py-7 text-white shadow-sm rounded-xl text-2xl font-bold bg-[#9AC6D1] animate-up-down hover:bg-[#86c0cf]" onClick={() => navigate("/main")}>Join Now</button>
    </div>
  );
};
